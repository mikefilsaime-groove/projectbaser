...
func (a *App) CreateTeam(team *model.Team) (*model.Team, error) {
        return a.store.CreateTeam(team)
}

func (a *App) AddUserToTeam(teamID, userID, role string) error {
        return a.store.AddUserToTeam(teamID, userID, role)
}

func (a *App) GetUserTeamRole(teamID, userID string) (string, error) {
        return a.store.GetUserTeamRole(teamID, userID)
}

func (a *App) GetPrimaryTeamForUser(userID string) (*model.Team, error) {
        return a.store.GetPrimaryTeamForUser(userID)
}
