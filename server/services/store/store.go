...
type Store interface {
	...
	GetUserByKeycloakSubID(keycloakSubID string) (*model.User, error)
        ...
        AddUserToTeam(teamID, userID, role string) error
        GetUserTeamRole(teamID, userID string) (string, error)
        GetPrimaryTeamForUser(userID string) (*model.Team, error)
