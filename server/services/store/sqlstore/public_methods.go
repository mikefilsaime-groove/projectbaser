...
func (s *SQLStore) CreateTeam(team *model.Team) (*model.Team, error) {
        return s.createTeam(s.db, team)

}

func (s *SQLStore) AddUserToTeam(teamID, userID, role string) error {
        return s.addUserToTeam(s.db, teamID, userID, role)

}

func (s *SQLStore) GetUserTeamRole(teamID, userID string) (string, error) {
        return s.getUserTeamRole(s.db, teamID, userID)

}

func (s *SQLStore) GetPrimaryTeamForUser(userID string) (*model.Team, error) {
        return s.getPrimaryTeamForUser(s.db, userID)
